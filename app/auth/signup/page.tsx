  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] px-4 relative">
      ...
      <div className="max-w-md w-full space-y-8 p-8 rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-card">
        ...
        <Link
          href="/public"
          className="block w-full rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-center text-sm font-medium text-[var(--foreground)] hover:bg-[var(--surface-hover)]"
        >
          관리자가 정리한 공부 노트 보기
        </Link>
      </div>
